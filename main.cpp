...
int main() {
    ...
    while(!quit){
        ...
        cout << "2.1. Maximum FLow of each City (1)" << endl;
        cout << "2.2. Cities in debt            (2)" << endl;
        cout << "2.3. Balancing the graph       (3)" << endl;
        cout << "3.1. Remove a reservoir        (4)" << endl;
        cout << "3.2. Remove a Pumping Station  (5)" << endl;
        cout << "3.3. Pipe failure             (6)" << endl;
        cout << "QUIT                      (7)" << endl;
        cout << "Choice: ";
